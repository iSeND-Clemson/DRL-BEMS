...
class HVACMPC:
    def __init__(self):
        self.u = cp.Variable(6, boolean=True)
    ...
    def optimize(self, state):
        ...
        for i in range(len(T)):
            ...
            temperature_difference_cooling = cp.maximum(T[i] - self.u[i]*74, 0)
            cooling_energy = (E/6) * temperature_difference_cooling
            
            temperature_difference_heating = cp.maximum(self.u[i]*71 - T[i], 0)
